...
#anonymized_csv="harmonized_clinical_data_anon.csv"
#anonymized_csv="harmonized_clinical_data_long_anon.csv"
#anonymized_csv="harmonized_clinical_data_min_anon.csv"
anonymized_csv="harmonized_clinical_data_anon.csv"
mipmap_anonym_output="./anonym_output"
anonymization_sql="anonymize_db_ides.sql"
pivoting_sql="pivot_i2b2_6_months_MRI_Diag_fed.sql"
crypto_function="sha224"
#crypto_function="md5"
#pivoting_sql="pivot_i2b2_longitudinal_fed.sql"
#pivoting_sql="pivot_i2b2_MinDate.sql"
#pivoting_sql="pivot_i2b2_MinDate_fed.sql"
#pivoting_sql="pivot_i2b2_MaxDate_fed.sql"
...
if [ -z $1 ]; then
    ...
    docker exec -it $postgres_name psql -U $db_user -d $db_anonym -c "SELECT anonymize_db('$crypto_function');"
